        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-5 mb-4">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                ...
                                >
                                    <i
                                        class="fa fa-users-cog fa-2x text-primary"
                                    ></i>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                ...
                                >
                                    <i
                                        class="fa fa-tachometer-alt fa-2x text-primary"
                                    ></i>
                                </div>
                                <h5 class="lh-base text-uppercase mb-0">
                    ...
                    <p>
                        <i class="fa fa-check-square text-primary me-3"></i>Many
                    ...
                    <div
                        class="border border-5 border-primary p-4 text-center mt-4"
                    >
                        <h4 class="lh-base text-uppercase mb-0">
                            We’re Good in All Metal Works Using Quality Welding
                            Tools
                        </h4>
                    </div>
                </div>
